...
print("Connecting to WiFi") # takeh from https://discover.captainmake.com/raspberry-pi-pico-w-connect-to-the-internet-circuitpython/
try:
...
# taken from https://learn.adafruit.com/magtag-progress-displays/circuitpython-internet-test
pool = socketpool.SocketPool(wifi.radio)
session = adafruit_requests.Session(pool, ssl.create_default_context())
elgato_url = "http://" + elgato_ip +":"+ elgato_port + "/elgato/lights"
print (elgato_url)
old_change = 0 #sync the ldr an d potmeter
